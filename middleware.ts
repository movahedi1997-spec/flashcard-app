...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon\\.ico|sitemap\\.xml|robots\\.txt|icons|uploads|downloads|.*\\.(?:png|jpg|jpeg|svg|js|mjs|json|webp|woff2?|ttf|map|css|ico|txt|xml|apk)$).*)',
  ],
};
