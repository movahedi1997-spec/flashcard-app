...
import type { Box, Card, StudyMode, StudyStats } from '../../types';
import { buildTurboDeck, buildScoreDeck } from '../../utils/study';
    ...
    return (
      <div className="max-w-md mx-auto text-center py-12 fade-in">
        ...
        <p className="text-lg font-semibold text-slate-700 mb-8">
          Accuracy: <span className={accuracy >= 70 ? 'text-emerald-600' : accuracy >= 40 ? 'text-amber-600' : 'text-red-600'}>{accuracy}%</span>
        </p>
